 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-image")) new core(".slider-image__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".slider-main")) new core(".slider-main__slider", {
                modules: [ Pagination, Parallax, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 20,
            ...
            if (document.querySelector(".slider-team")) new core(".slider-team__slider", {
                ...
                navigation: {
                    prevEl: ".arrows .arrow_prev",
                    nextEl: ".arrows .arrow_next"
                }
            });
        }
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (targetElement.classList.contains("form-cart__close")) document.querySelector(".form-cart__content").classList.toggle("_clear");
            }
        };
        window["FLS"] = true;
        isWebp();
